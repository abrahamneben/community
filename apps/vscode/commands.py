...
ctx.lists["self.chromatic_commands"] = {
    ...
    "update left bud": "bazel run  //chromatic/fw/infra/flux:cli --//chromatic/fw/projects:fw_stamping=forced  -- update buds --model dual --side left\n",
    "update right bud": "bazel run  //chromatic/fw/infra/flux:cli --//chromatic/fw/projects:fw_stamping=forced  -- update buds --model dual --side right\n",
